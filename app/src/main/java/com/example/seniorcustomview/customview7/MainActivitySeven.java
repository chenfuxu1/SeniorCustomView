package com.example.seniorcustomview.customview7;
...
import com.example.seniorcustomview.customview7.fragment.MaterialEditTextFg;
...
public class MainActivitySeven extends AppCompatActivity {
    ...
    // tabLayout 的标题
    private String[] mTabTitle = {"MaterialEditText"};
    ...
    private void initData() {
        MaterialEditTextFg materialEditTextFg = new MaterialEditTextFg();
        mData.clear();
        mData.add(materialEditTextFg);
    }
