 ...
 * Create By: ChenFuXu
 * DateTime: 2022/12/20 23:53
 *
 * PropertyValuesHolder 动画
 **/
public class PropertyValuesHolderView extends View {
    ...
    private PropertyValuesHolder mBottomFlipHolder;
    private PropertyValuesHolder mFlipRotateHolder;
    private PropertyValuesHolder mTopFlipHolder;
    private ObjectAnimator mValueAnimator;

    {
        mBitmap = Utils.getAvatar((int) BITMAP_WIDTH, R.mipmap.liu);
        /**
    ...
    public PropertyValuesHolderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public PropertyValuesHolderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void startAnim() {
         ...
         * 1、底部向上翻折 45 度
         */
        mBottomFlipHolder = PropertyValuesHolder.ofFloat("bottomFlipAngle", 0, 45);
        /**
         * 2、整体旋转 270 度
         */
        mFlipRotateHolder = PropertyValuesHolder.ofFloat("flipRotateAngle", 0, 270);
        /**
         * 3、顶部向上翻折的动画
         */
        mTopFlipHolder = PropertyValuesHolder.ofFloat("topFlipAngle", 0, -45);

        mValueAnimator = ObjectAnimator.ofPropertyValuesHolder(this, mBottomFlipHolder, mFlipRotateHolder, mTopFlipHolder);
    ...
    public void resetAnim() {
         ...
         * 1、顶部向下翻折的动画
         */
        mTopFlipHolder = PropertyValuesHolder.ofFloat("topFlipAngle", -45, 0);
        /**
         * 2、整体旋转 -360 度
         */
        mFlipRotateHolder = PropertyValuesHolder.ofFloat("flipRotateAngle", 270, 0);
        /**
         * 3、底部向下翻折 45 度
         */
        mBottomFlipHolder = PropertyValuesHolder.ofFloat("bottomFlipAngle", 45, 0);

        mValueAnimator = ObjectAnimator.ofPropertyValuesHolder(this, mTopFlipHolder, mFlipRotateHolder, mBottomFlipHolder);
        mValueAnimator.setStartDelay(500);
        mValueAnimator.setDuration(2000);
        mValueAnimator.start();
    }
