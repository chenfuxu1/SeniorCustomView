 ...
 **/
public class XfermodeViewSrcOver extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.SRC_OVER); // 源图覆盖在目标图上方
    ...
    public XfermodeViewSrcOver(Context context) {
        this(context, null);
    }

    public XfermodeViewSrcOver(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewSrcOver(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewSrcOver(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
