 ...
 **/
public class XfermodeViewDstAtop extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_ATOP); // 以源图为准，重叠部分显示目标图
    ...
    public XfermodeViewDstAtop(Context context) {
        this(context, null);
    }

    public XfermodeViewDstAtop(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewDstAtop(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewDstAtop(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
