 ...
 **/
public class XfermodeViewClear extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.CLEAR); // 都不显示
    ...
    public XfermodeViewClear(Context context) {
        this(context, null);
    }

    public XfermodeViewClear(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewClear(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewClear(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
