 ...
 **/
public class XfermodeViewDstIn extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_IN); // 目标图显示在源图区域范围内
    ...
    public XfermodeViewDstIn(Context context) {
        this(context, null);
    }

    public XfermodeViewDstIn(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewDstIn(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewDstIn(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
