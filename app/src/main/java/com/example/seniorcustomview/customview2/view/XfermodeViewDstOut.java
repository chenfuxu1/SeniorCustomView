 ...
 **/
public class XfermodeViewDstOut extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_OUT); // 取源图之外的所有内容
    ...
    public XfermodeViewDstOut(Context context) {
        this(context, null);
    }

    public XfermodeViewDstOut(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewDstOut(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewDstOut(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
