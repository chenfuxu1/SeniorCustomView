 ...
 **/
public class XfermodeViewDst extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST); // 只显示目标图
    ...
    public XfermodeViewDst(Context context) {
        this(context, null);
    }

    public XfermodeViewDst(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewDst(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewDst(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
