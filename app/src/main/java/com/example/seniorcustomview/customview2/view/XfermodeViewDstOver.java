 ...
 **/
public class XfermodeViewDstOver extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_OVER); // 目标图覆盖在源图上方
    ...
    public XfermodeViewDstOver(Context context) {
        this(context, null);
    }

    public XfermodeViewDstOver(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewDstOver(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewDstOver(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
