 ...
 **/
public class XfermodeViewXor extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.XOR); // 目标图与源图重叠部分不显示
    ...
    public XfermodeViewXor(Context context) {
        this(context, null);
    }

    public XfermodeViewXor(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewXor(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewXor(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
