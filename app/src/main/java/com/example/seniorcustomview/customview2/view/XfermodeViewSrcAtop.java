 ...
 **/
public class XfermodeViewSrcAtop extends View {
    private static final String TAG = "XfermodeViewSrc";
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.SRC_ATOP); // 以目标区域为准，重叠部分显示源图
    ...
    public XfermodeViewSrcAtop(Context context) {
        this(context, null);
    }

    public XfermodeViewSrcAtop(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewSrcAtop(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewSrcAtop(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
