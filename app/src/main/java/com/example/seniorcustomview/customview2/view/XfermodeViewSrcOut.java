 ...
 **/
public class XfermodeViewSrcOut extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.SRC_OUT); // 取目标图之外的所有内容
    ...
    public XfermodeViewSrcOut(Context context) {
        this(context, null);
    }

    public XfermodeViewSrcOut(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewSrcOut(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewSrcOut(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
