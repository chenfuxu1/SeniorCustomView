 ...
 **/
public class XfermodeViewSrc extends View {
...

    {
        ...
        mXfermode = new PorterDuffXfermode(PorterDuff.Mode.SRC); // 只显示源图
    ...
    public XfermodeViewSrc(Context context) {
        this(context, null);
    }

    public XfermodeViewSrc(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XfermodeViewSrc(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XfermodeViewSrc(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
